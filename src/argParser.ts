...
function printUsage() {
  console.log('Usage:')
  console.log(
    '    malt -L [learningAlgorithm] -A [ARFF_File] -E [evaluationMethod] {[extraParameters]} [OPTIONS]\n'
  )
  console.log('OPTIONS:')
  console.log(
  ...
  console.log(
    '    MLSystemManager -L [learningAlgorithm] -A [ARFF_File] -E random [%_ForTraining]'
  )
  console.log(
